...
public class GenerateCircles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < ((playerHeight - 100) * 0.01f); i++) // Instantiate circles. Quantity depends on player initial height.
        {
        ...
        {
            child.position = new Vector3(0,(child.transform.GetSiblingIndex() + 1) * 100, 0);
        }
    }
}
